...
var guidePayload = GuideOutput{
	...
	RecommendedFlow: []string{
		...
		"Call search with a compliance question or control citation. Use the framework filter for ~88% recall (vs ~72% unfiltered) when you know the target framework. Citation-shaped queries (AC-2, A.5.1, CC6.1) get a direct DB lookup pinned at score 1.0.",
