...
type SearchInput struct {
	...
	Framework        string `json:"framework,omitempty" jsonschema:"framework code filter — raises recall to ~91% (vs ~84% unfiltered) unfiltered); codes are listed by corpus_status (e.g. nist80053, iso27001, pcidss, ciscontrols, soc2tsc)"`
