...
| `mapping_source` | Provenance vocab for mapping edges | `code` (`nist-olir`, `csa-ccm-v4.1`, `cis-v8.1-mappings`, `publisher-catalog`, `iso-structural`, `operator`) · `name` · `authority_note` | `(code)` |
