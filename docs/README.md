...
- [`ARCHITECTURE.md`](ARCHITECTURE.md) — system overview: principles, pipeline, MCP surface,
  repo layout, stack.
- [`design/SCHEMA.md`](design/SCHEMA.md) — data model: registry, manifest, bronze/silver/gold,
